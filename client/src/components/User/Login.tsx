    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 text-purple-500 mx-auto my-20 sm:w-3/4 lg:w-1/2">
                ...
                <input className="mx-10 bg-purple-200" type="text" id="username" onKeyUp={e => enterSubmit(e)}/>
                <label className="my-10">Password</label>
                <input className="my-10 mx-10 bg-purple-200" type="password" id="password" onKeyUp={e => enterSubmit(e)}/>
                <a className={button + " mr-10"} href="/user/register">Register</a>
                <a className={button} onClick={e => submitForm()}>Login</a>
            </div>
        </>
    )
}
