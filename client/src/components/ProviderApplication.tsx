  ...
  const onSubmit = async () => {
    if (
      ...
      if (auth.success) {
        ...
        if (providerID)
          await Provider.setAddress(providerID, auth.data.address._id);
    ...
    >
      ...
      <Modal.Body>
        <div className="form-group mb-4">
          ...
          <input
            className={
              errors.street1 ? "form-control is-invalid" : "form-control"
            }
            type="text"
        ...
        <div className="form-group mb-4">
          ...
          <input
            className={
              errors.street2 ? "form-control is-invalid" : "form-control"
            }
            type="text"
